    ...
    "venice": [
        {
            ...
            "sizing_mode": "mixed",
            "pricing": {"unit": "unknown", "source": "Venice models endpoint may provide account-current pricing."},
        ...
        },
        {
            ...
            "pricing": {"unit": "unknown", "source": "Refresh Venice model metadata to check current pricing."},
        ...
        },
        {
            ...
            "sizing_mode": "pixel",
            "pricing": {"unit": "unknown", "source": "Refresh Venice model metadata to check current pricing."},
            "notes": "Venice docs list this as a pixel-dimension model.",
        },
        {
            "id": "venice-sd35",
            "label": "Venice SD 3.5",
    ...
    "fal": [
        {
            ...
            "pricing": {"unit": "unknown", "source": "Use Fal pricing refresh for account-current pricing."},
        ...
        },
        {
            ...
            "category": "text-to-image",
            "fal_payload_style": "image_size",
            "pricing": {"unit": "image", "usd": 0.025, "source": "Fal pricing API documentation example; refresh for current account pricing."},
        ...
        },
        {
            ...
            "category": "text-to-image",
            "fal_payload_style": "image_size",
            "pricing": {"unit": "megapixel_rounded_up", "usd": 0.05, "source": "Fal model page."},
            "notes": "Advanced control with adjustable inference steps and guidance scale, stronger typography. Fal notes per-megapixel billing rounded up.",
        },
        {
